...
/// @return Whether the specified video decoding format is supported; YES means supported, you can use this decoding format for playing stream; NO means not supported, and the decoding format cannot be used for play stream.

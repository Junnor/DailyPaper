...
- (void)requestSong:(ZegoCopyrightedMusicRequestConfig *)config
           callback:(nullable ZegoCopyrightedMusicRequestSongCallback)callback;
...
/// Default value: The default value of recive range is 0.0 .
/// Restrictions: None.
/// Caution: None.
///
...
- (int)setReciveRange:(float)range;
...
/// @return Error code, please refer to the error codes document https://doc-en.zego.im/en/5548.html for details.
- (int)loginScene:(ZegoSceneParam *)config
...
/// @return Error code, please refer to the error codes document https://doc-en.zego.im/en/5548.html for details.
- (int)sendCustomCommand:(NSData *)command
